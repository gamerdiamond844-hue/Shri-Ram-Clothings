    ...
    <LegalPage title="Privacy Policy" lastUpdated="January 1, 2026">
      ...
      <Section num="3" title="Categories of Personal Data Collected">
        ...
        <Sub title="3.3 Transaction & Financial Data">
          <List items={[
            ...
            'Razorpay payment tokens and encrypted card metadata',
      ...
      <Section num="6" title="Cookies & Tracking Technologies">
        ...
        <Sub title="6.2 Third-Party Tracking">
          We use Google Analytics, Meta Pixel, Razorpay analytics, and other third-party tracking tools. These services may collect data independently under their own privacy policies. You may opt out of Google Analytics tracking at <strong>tools.google.com/dlpage/gaoptout</strong>.
        </Sub>
      ...
      <Section num="7" title="Data Sharing & Third-Party Disclosure">
        ...
        <List items={[
          'Payment Processors: Razorpay India Pvt Ltd for secure payment processing.',
